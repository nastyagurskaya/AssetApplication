...
namespace AssetODataService
{
    public class AssetODataServiceContext : XpoContext
    {
        public AssetODataServiceContext(string s1, string s2, IDataLayer dataLayer)
    ...
    [JSONPSupportBehavior]
#endif
    public class AssetODataServiceService : XpoDataServiceV3
    {
        static readonly AssetODataServiceContext serviceContext = new AssetODataServiceContext("AssetODataServiceService", "AssetODataService.DB_TN_EAM", CreateDataLayer());

        public AssetODataServiceService() : base(serviceContext, serviceContext) { }

        static IDataLayer CreateDataLayer()
        {
            DevExpress.Xpo.Metadata.XPDictionary dict = new DevExpress.Xpo.Metadata.ReflectionDictionary();
			dict.GetDataStoreSchema(typeof(AssetODataServiceService).Assembly);
			IDataLayer dataLayer = new ThreadSafeDataLayer(dict, global::AssetODataService.DB_TN_EAM.ConnectionHelper.GetConnectionProvider(DevExpress.Xpo.DB.AutoCreateOption.SchemaAlreadyExists));
