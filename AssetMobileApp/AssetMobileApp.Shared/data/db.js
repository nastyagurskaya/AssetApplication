...
(function() {
    ...
    var endpointSelector = new DevExpress.EndpointSelector(AssetMobileApp.config.endpoints);
    var serviceConfig = $.extend(true, {}, AssetMobileApp.config.services, {
        db: {
    ...
    AssetMobileApp.db = new DevExpress.data.ODataContext(serviceConfig.db);
